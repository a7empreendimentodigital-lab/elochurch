...
import { createReceitaAction } from "@/app/financeiro/actions";
...
export function ReceitaForm({ igrejaId, dataDefault }: ReceitaFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const result = await createReceitaAction({
        igrejaId,
        descricao,
        valor,
        data,
  ...
  return (
    <EloCard title="Registrar receita" className="mx-auto max-w-lg">
