...
export function PortalNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card/95 backdrop-blur-md md:static md:border-t-0 md:bg-transparent md:backdrop-blur-none">
      <div className="mx-auto flex max-w-lg items-center justify-around gap-1 px-2 py-2 md:max-w-none md:flex-col md:items-stretch md:gap-1 md:px-3 md:py-4">
        {items.map((item) => {
          ...
          return (
            ...
            >
              <Icon className={cn("h-5 w-5 md:h-4 md:w-4", isActive && "text-gold")} />
